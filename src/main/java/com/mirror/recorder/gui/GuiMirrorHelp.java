...
public class GuiMirrorHelp extends GuiScreen{
    ...
    private static final String[][] RU={
        ...
        {"Защита и корзина",
         ...
         "§8Тумблер: Настройки → Запись → «Стоп при уроне».",
         "",
         "§fКорзина",
         "§7Удалённая запись не исчезает: копия ложится в корзину.",
         "§7Настройки → Общие → «Корзина»: нажмите карточку, затем большую зелёную кнопку «Вернуть в слот».",
    ...
    private static final String[][] EN={
        ...
        {"Safety and trash",
         ...
         "§8Toggle: Settings → Recording → \"Stop when hurt\".",
         "",
         "§fTrash",
         "§7A deleted recording does not vanish: a copy goes to the trash.",
         "§7Settings → General → Trash: tap a card, then the big green Restore to slot button.",
    ...
    private static final String[][] UK={
        ...
        {"Захист і кошик", "§fСтоп при шкоді", "§7Якщо по вас влучили, мод одразу вимикає запис або повтор і відпускає всі клавіші.", "§8Перемикач: Налаштування → Запис → «Стоп при шкоді».", "", "§fКошик", "§7Видалений запис не зникає: копія лягає у кошик.", "§7Налаштування → Загальні → «Кошик»: натисніть картку, потім велику зелену кнопку «Повернути в слот».", "§7«Останнє видалення» повертає те, що прибрали щойно. «Очистити все» питає ще раз.", "§8Зберігаються 100 останніх видалень, слот для повернення має бути порожнім."},
    };
    private static final String[][] DE={
        ...
        {"Sicherheit und Papierkorb", "§fStopp bei Schaden", "§7Wenn dich etwas trifft, stoppt die Mod sofort Aufnahme oder Wiedergabe und lässt alle Tasten los.", "§8Schalter: Einstellungen → Aufnahme → «Stopp bei Schaden».", "", "§fPapierkorb", "§7Eine gelöschte Aufnahme verschwindet nicht: eine Kopie landet im Papierkorb.", "§7Einstellungen → Allgemein → «Papierkorb»: tippe eine Karte an, dann den großen grünen Knopf «Wiederherstellen in Slot».", "§7«Letzte Löschung» holt zurück, was du gerade entfernt hast. «Alles leeren» fragt noch einmal.", "§8Die letzten 100 Löschungen werden aufbewahrt, und der Zielslot muss leer sein."},
    };
